...
val signingStorePassword: String = signingCredential("SM_KEYSTORE_PASSWORD", "cfscanner")
val signingKeyAlias: String = signingCredential("SM_KEY_ALIAS", "cf-scanner")
val signingKeyPassword: String = signingCredential("SM_KEY_PASSWORD", "cfscanner")
